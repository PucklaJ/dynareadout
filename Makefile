...
dynareadout_cpp_CXX=/usr/bin/gcc
dynareadout_AR=/usr/bin/ar
dynareadout_CC=/usr/bin/gcc
...
build/.objs/dynareadout_cpp/linux/x86_64/release/src/cpp/include_transform.cpp.o: src/cpp/include_transform.cpp
	...
	@mkdir -p build/.objs/dynareadout_cpp/linux/x86_64/release/src/cpp
	$(VV)$(dynareadout_cpp_CXX) -c $(dynareadout_cpp_CXXFLAGS) -o build/.objs/dynareadout_cpp/linux/x86_64/release/src/cpp/include_transform.cpp.o src/cpp/include_transform.cpp
